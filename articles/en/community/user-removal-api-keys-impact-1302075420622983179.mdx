...
description: "Guide explaining the impact of user removal on API keys in Deepgram projects."
summary: "This article outlines what happens to API keys when a user is removed from a Deepgram project. It covers key ownership, automatic revocation on user removal, and steps to ensure minimal disruption in production environments."
---
