...
description: "Learn how to integrate Deepgram's medical speech-to-text model for real-time transcription."
summary: "This guide explores building a minimum viable product using Deepgram's Nova-2 Medical model, designed for accurate real-time transcription of medical terminology. It covers setting up your Deepgram account, obtaining API credentials, and effectively utilising the API for clinical documentation workflows."
---
