---
title: "Resolving Discrepancies in Finalized Transcripts with Smart Formatting"
description: "Resolving inconsistencies between interim and finalised transcripts with Deepgram's Speech-to-Text API."
summary: "This article explains why discrepancies can occur between interim and finalised transcripts when using certain configuration parameters with Deepgram's Speech-to-Text API. It provides guidance on resolving these inconsistencies through proper parameter usage."
---
