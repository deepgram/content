...
description: "Guide to troubleshooting and resolving issues with Deepgram Voice Agent API function integration."
summary: "When integrating Deepgram's Voice Agent API, you may encounter situations where the agent doesn't respond as expected when functions are added to your settings. This guide outlines steps to effectively address and troubleshoot these issues, ensuring proper interactive responses from the agent."
---
