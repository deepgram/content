---
title: "Resolving 'Tasks Cancelled Error' in Deepgram's Async Live STT"
description: "Guide to resolving 'tasks cancelled error' with Deepgram's async live speech-to-text API."
summary: "This article explores common causes of the 'tasks cancelled error' encountered when using Deepgram's async live speech-to-text API, such as connection timeouts, unsupported audio, or network issues. It provides potential solutions like increasing timeout settings and ensuring audio quality."
---

<CommunityQuestion>I'm getting a 'tasks cancelled error' when using Deepgram's async live speech-to-text API for longer audio files. How can I resolve this frustrating issue?</CommunityQuestion>
